...
var connectDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                mongoURI = process.env.MONGODB_URI || 'mongodb://localhost:27017/claimassist';
                return [4 /*yield*/, mongoose_1.default.connect(mongoURI, {
                    // Modern connection options (deprecated options removed)
                    })];
            case 1:
                _a.sent();
                logger_1.logger.info("MongoDB connected: ".concat(mongoose_1.default.connection.host));
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                logger_1.logger.error('MongoDB connection error:', error_1);
                throw error_1;
